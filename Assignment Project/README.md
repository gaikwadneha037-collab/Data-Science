ServiceHive: Agentic Sales & Support Assistant
ServiceHive is an intelligent agentic system designed to handle pricing inquiries (via RAG) and capture high-intent leads (via Tool Calling). Powered by GPT-4o-mini and orchestrated with LangGraph, it moves beyond simple chatbots by managing a complex state-driven workflow.
